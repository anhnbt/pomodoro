...
const TIME_FOR_A_BREAK = "Thời gian cho nghỉ ngơi!";
const TIME_TO_FOCUS = "Đã đến lúc tập trung!";
const START = "Bắt đầu";
const PAUSE = "Tạm dừng";
const RESET = "Đặt lại";

export const DEFAULT_POMODORO_TIME = 25; // Phút
export const DEFAULT_SHORT_BREAK_TIME = 5; // Phút
export const DEFAULT_LONG_BREAK_TIME = 15; // Phút
